...
class Adduser extends CI_Controller {
	...
	$checkmsg  = $this->usermanagement->checkusername($this->input->post('uName'));
	if($checkmsg == TRUE )
	{
	$this->session->set_userdata('updated','User name already exist');
	}
	else
	{
	$msg  = $this->usermanagement->insertuser();
	$this->session->set_userdata('updated','User Added Succcessfully');
	}
