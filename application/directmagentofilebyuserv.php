				...
				<div class="box">
					...
					<div class="box-content">
						<table width="100%" border="0" cellpadding="5">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td><input type="submit" class="btn btn-primary" value="Process File" onclick="return processdirectmagentodata('<?php echo BASE_URL; ?>',<?php echo $this->uri->segment(3); ?>);" /></td>
                          </tr>
                        </table>
                 </div>
				</div>
