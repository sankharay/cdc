...
class addfinalproductdatam extends CI_Model
{
	...
	function senddatatodb($file,$vendortemplatedetails,$vendorid,$vendoruserid)
	{
		$columns = array();
	...
	function insertspanishdata($data,$englishid)
	{
			...
			{
				$data['prduct_name'] = htmlspecialchars($this->translateplaintext($data['prduct_name']));
			}
			if(isset($data['short_description']))
			{
				$data['short_description'] = htmlspecialchars($this->translateplaintext($data['short_description']));
			}
			if(isset($data['product_description']))
			{
				$data['product_description'] = htmlspecialchars($this->translateplaintext($data['product_description']));
			}
			if(isset($data['product_metatags']))
			{
				$data['product_metatags'] = htmlspecialchars($this->translateplaintext($data['product_metatags']));
			}
			if(isset($data['product_metadescription']))
			{
				$data['product_metadescription'] = htmlspecialchars($this->translateplaintext($data['product_metadescription']));
			}
			// translate data ends
