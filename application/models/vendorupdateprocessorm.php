<?php
class vendorupdateprocessorm extends CI_Model
{
  ...
  $data.="<tr>";
  $data.="<td>";
  $data.="<input type='hidden' name='cells[]' value='".$excel->sheets[0]['cells'][3][$i]."'>";
  ...
  for($i=2;$i<=$numrows;$i++){
	...
	function addnewtemplate($dbfields,$excelfields,$vendorid)
	{
		$filename = $_GET['file'];
		$data = array
				(	
