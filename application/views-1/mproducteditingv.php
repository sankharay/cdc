...
<input type="number" name="pSpecialPrice" id="pSpecialPrice" class="input-xlarge" style="width:160px;" value="<?php echo $content->specialprice; ?>" placeholder="Enter Special Price" >
<?php
if($content->specialfromdate != "")
$FromDate = date("d/m/Y", strtotime($content->specialfromdate));
else
$FromDate="";
if($content->specialtodate != "")
$ToDate = date("d/m/Y", strtotime($content->specialtodate));
else
$ToDate="";
?>
<input type="text" style="width:160px;" name="pSpecialFromDate" id="pSpecialFromDate" class="input-xlarge datepicker" value="<?php echo $FromDate; ?>" placeholder="From Date" > To 
<input type="text" style="width:160px;" name="pSpecialToDate" id="pSpecialToDate" class="input-xlarge datepicker" value="<?php echo $ToDate; ?>" placeholder="To Date"  >
</fieldset>
<fieldset>
...
<input type="text" name="pShipping" id="pShipping" class="span6 typeahead" value="<?php echo $content->shippingprice; ?>" required="required" placeholder="Shipping Price" >
</fieldset>
<fieldset>
