        ...
        <article class="module width_half">
			<header><h3>English Copy</h3></header>
				...
				<div class="module_content">
						...
						<fieldset>
							<label>Product Name&nbsp;&nbsp;<button value="Translate" class="btn btn-mini btn-primary"  onclick="return translateitems('<?php echo BASE_URL; ?>','pName')">Translate</button></label>
                            
							<input type="text" name="pName" id="pName" required  value="<?php echo $row['prduct_name']?>" style="width:92%;">
...
<select name="disclaimer" id="disclaimer" onchange="return disclaimerchange(this.value);">
<option value="">Please select disclaimer</option>
<?php foreach($disclaimer as $valuesdis)
{
?>
<option value="<?php echo $valuesdis->id; ?>" <?php if($valuesdis->id == $row['product_disclaimer']) { echo "selected='selected'"; } ?>><?php echo $valuesdis->english; ?></option>
<?php
}
?>
</select>
				...
				<div class="module_content">
                    ...
                    <form action="index.php/englishready" method="post">
                        ...
                        <fieldset>
							...
							<input type="text" name="pName" id="spName" required  value="<?php echo $sprow['prduct_name']?>" style="width:92%;">
						</fieldset>
						...
						<fieldset>
							...
							<textarea rows="12" name="psDesc" id="spDesc" required  style="width:490px;" class="cleditor">
...
<fieldset>
<label>Video Link&nbsp;&nbsp;</label>
<textarea rows="12" name="psVideo" id="psVideo"  style="width:90%; height:80px;"></textarea>
</fieldset>
                        <footer><br />
                        <div class="submit_link">
