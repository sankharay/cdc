	<noscript>
        ...
        <article class="module width_full">
				<div class="module_content">
                    <form action="<?php echo BASE_URL; ?>/contentsearch/englishready" method="post">
...
<li class=""><a href="#metainformation">Metatags</a></li>
						</ul>
...
<input type="text" name="pBrand" id="pBrand" value="<?php echo $_POST['brand']?>" class="span6 typeahead" required="required"></fieldset>
<fieldset>
<label>Product Disclaimer</label>
<input type="text" name="pDisclaimer" id="pDisclaimer" value="" class="span6 typeahead" required="required"></fieldset>
<fieldset>
...
{
	?>
<option value="<?php echo $vendordata->vmID; ?>" <?php if($vendordata->vmID == $productdetails->product_source) { echo "selected='selected'"; } ?>><?php echo $vendordata->vendorName; ?></option>
    <?php
