				...
				<div class="box">
					...
					<div class="box-content">
						<table width="100%" border="0" cellpadding="5">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td><input type="submit" class="btn btn-primary" value="Process File" onclick="return processmagentodata('<?php echo PLUGINS_WEB_URL; ?>',<?php echo $this->uri->segment(3); ?>);" /></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
...
<div id="waiting" class="waiting" ><img src="<?php echo BASE_URL; ?>/img/loader.gif" width="32" height="32" /></div>
		...
		<script>
function processmagentodata(url,file){
