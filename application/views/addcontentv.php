...
<?php echo $this->contentsearchm->get_vendor_names($value->product_source); ?>
                                ...
                                <span class="label label-success">
									<?php echo $this->log->content_status($value->status);  ?>
                                    </span>
                                    <br />
                                    <?php
									if($value->status == 13)
									{
									?>
                                    <span class="label label-warning" data-rel="tooltip" href="#" data-original-title="<?php echo $value->comment; ?>">Reason</span>
                                    <?php
									}
									?>
								</td>
								...
								{
									?>
                                <a href="<?php echo BASE_URL; ?>/addcontent/desc/<?php echo $value->product_upc; ?>/<?php echo $value->product_source; ?>" class="btn btn-success">
								...
								{
									?>
                                <a href="<?php echo BASE_URL; ?>/addcontent/contentfailed/<?php echo $value->mpt_id; ?>" class="btn btn-success">
										<i class="icon icon-white icon-check"></i>                                            
									</a>
                                    <?php
								}
