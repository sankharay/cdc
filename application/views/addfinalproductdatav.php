<noscript>
			...
			<div class="row-fluid sortable">
				...
				<form enctype="multipart/form-data" action="<?php echo BASE_URL; ?>/addfinalproductdata/uploadfile/" method="post">
...
{
	?>
<a href="<?php echo BASE_URL; ?>/addfinalproductdata/processfinalfilebyuser/<?php echo $value->id; ?>">
