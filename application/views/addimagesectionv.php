				  ...
				  <div class="box-content">
                    ...
                    <!-- &nbsp;&nbsp;<a href="<?php echo BASE_URL; ?>/productpreview/spanish_index.php?fpl_id=<?php echo $this->uri->segment(3); ?>" target="_blank"><button class="btn btn-mini btn-primary" id="finalproductview">Final Spanish Preview</button></a>-->&nbsp;&nbsp;<button class="btn btn-mini btn-primary" id="asearch">Advance Search</button></div>
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  {
$product_details = $this->addcontentm->get_content_englishtables($value->finalproductlist_fpl_id);
							  ?>
							  
							<tr>
				<td><?php echo $this->addcontentm->getvendorname($product_details->product_source); ?></td>
								<td>
...
<td class="center"><?php echo $this->addcontentm->imagelang($value->image_lanauage); ?> / <?php echo $value->image_position; ?> </td>
<td class="center"><?php echo $product_details->product_sku; ?></td>
								<td class="center">
  <?php echo $product_details->product_upc; ?>
							    </td>
								<td class="center">
<a href="<?php echo BASE_URL; ?>/addcontent/imgedit/<?php echo $value->img_id; ?>/<?php echo $this->uri->segment(3); ?>" class="cboxElement"><button class="btn btn-mini btn-primary">Edit</button></a>&nbsp;
	...
	<th rowspan="1" colspan="1">
      ...
      <div class="modal hide fade" id="myModal">
			...
			<div class="modal-footer">
				...
				<a href="#" onclick="return confirmproductothers('<?php echo BASE_URL; ?>',<?php echo $this->uri->segment(3); ?>);" class="btn btn-primary">Save changes</a>
			</div>
		</div>
      </th>
</tr>
