			...
			<div class="row-fluid sortable">
				...
				<div class="box">
					<div class="box-header well">
						<h2><i class="icon-list-alt"></i> Select Type Of Insert</h2>
						<div class="box-icon">
				...
				<a href="#" onclick="return additem('manual')" class="well span3 top-block" data-rel="tooltip" data-original-title="Enter Products Manually">
					<span class="icon32 icon-red icon-user"></span>
					<div>Manual Entry</div>
				</a>

				<a href="#" onclick="return additemexcel()" class="well span3 top-block" data-rel="tooltip" data-original-title="Enter Data With Excel File">
                ...
                <div class="box">
					<div class="box-header well">
						<h2><i class="icon-list-alt"></i> Upload File</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
					...
					<div class="box-content">
                        <div class="sortable row-fluid ui-sortable">
				<form enctype="multipart/form-data" action="<?php echo BASE_URL; ?>/addproduct/uploadfile/" method="post">
                ...
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  foreach($content as $value)
						  {
							...
							<tr>
								...
								<td class="center">
                                <?php echo $this->addproductm->filestatus($value->status); ?>
                                </td>
								<td class="center">
<?php
if($value->status == 1)
{
	?>
<a href="<?php echo BASE_URL; ?>/processfilebyuser/index/<?php echo $value->id; ?>">
<input type="button" class="btn btn-primary" value="Insert Products" />
</a>
<?php
}
else
