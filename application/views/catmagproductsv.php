	...
	<th rowspan="1" colspan="1">
		<input type="text" class="search_init" value="Search SKU" name="search_sku">
						  ...
						  foreach($content as $value)
						  {
							...
							<tr>
								<td>
<input type="checkbox" class="addsons" name="addon[]" value="<?php echo $value->magproductid; ?>" /></td>
<td><?php echo $value->productname; ?></td>
<td><?php echo $value->productsku; ?></td>
<td><?php echo $value->productupc; ?></td>
<td><?php echo $value->productPrice; ?></td>
<td><?php echo $this->log->active_status($value->productStatus); ?></td>
							</tr>
