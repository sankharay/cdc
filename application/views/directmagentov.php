			...
			<div class="row-fluid sortable">
                ...
                <div class="box">
					<div class="box-header well">
						<h2><i class="icon-list-alt"></i> Upload File to Push Magento Directly</h2>
						<div class="box-icon">
				...
				<form enctype="multipart/form-data" action="<?php echo BASE_URL; ?>/directmagento/uploadfile/" method="post">
...
{
	?>
<a href="<?php echo BASE_URL; ?>/directmagento/processfinalfilebyuser/<?php echo $value->id; ?>">
