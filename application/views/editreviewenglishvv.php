...
<noscript>
			...
			<form action="<?php echo BASE_URL; ?>/addcontentenglish/onlyenglishreadys/<?php echo $this->uri->segment(3); ?>" method="post" onsubmit="return checkcategory()">
...
{
	?>
<option value="<?php echo $vendordata->vendorID; ?>" ><?php echo $vendordata->vendorName; ?> - <?php echo $vendordata->vendorID; ?></option>
    <?php
...
$cataid  = $english_content->product_category;
...
echo $newatt = $english_content->attributes;
?>
...
$catarray = explode('_',$english_content->product_category);
$abcd = new RightMenu();
echo $abcd->getadonselectionMenu($parent = 0,$catarray);
}
else
{
$abcd = new RightMenu();
echo $abcd->getaddonMenu();
}
?>
</div>
</p>
