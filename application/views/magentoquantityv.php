<noscript>
			...
			<div>
				<ul class="breadcrumb">
					<li>
						<a href="#">Home</a> | Update Quantity to Magento
				  </li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
                ...
                <div class="box">
					<div class="box-header well">
						<h2><i class="icon-list-alt"></i> Upload File to Update Quantity to Magento</h2>
						<div class="box-icon">
...
{
	?>
<a href="<?php echo BASE_URL; ?>/magentoquantity/processfinalfilebyuser/<?php echo $value->id; ?>">
<input type="button" class="btn btn-primary" value="Update Magento Quantity" />
</a>
<?php
}
else
