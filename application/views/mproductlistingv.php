...
<noscript>
			...
			<form action="<?php echo BASE_URL; ?>/magentoediting/onlyenglishready/<?php echo $this->uri->segment(3); ?>" method="post" onsubmit="return checkcategory()">
    ...
    <section id="main" class="column">
        ...
        <article class="module width_half">
			<header><h3>English Copy</h3></header>
			   ...
			   {
				?>
<input type="hidden" name="statusupdate" id="statusupdate" required  value="1" style="width:92%;">
<input type="hidden" name="inmagento" id="inmagento" required  value="3" style="width:92%;">
                <?php   
			   }
			   else
			   {
				   ?>
<input type="hidden" name="statusupdate" id="statusupdate" required  value="15" style="width:92%;">
<input type="hidden" name="inmagento" id="inmagento" required  value="1" style="width:92%;"> 
<?php
			   }
			   ?>
                            <br />
...
<?php
$cataids  = explode('_',$english_content->product_category);
$cataid = $cataids[0];
...
echo $english_content->attributes;
...
<table width="100%" border="0">
  <tr>
    ...
    <td><label>Spanish Product Keywords</label>
							<textarea rows="12" name="spanishkeywords" class="span12 typeahead" id="pSpecs" required="required"><?php echo $spanish_content->product_metatags; ?></textarea>
						</fieldset></td>
  </tr>
  <tr>
    ...
    <td><label>Spanish Product Descriptions</label>
							<textarea rows="12" name="spanishkeyworddescription" class="span12 typeahead" id="pSpecs" required="required"><?php echo $spanish_content->product_metadescription; ?></textarea>
						</fieldset></td>
  </tr>
</table>
</div>
