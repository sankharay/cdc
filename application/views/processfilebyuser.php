	...
	$this->load->view('footer');	
	 ...
	 function useraccessingapi()
	 {
		 ...
		 else
		 {
			...
			$this->email->from('sandeepk@icurocao.com', 'CDC Support');
			$this->email->reply_to('sandeepk@icurocao.com', 'CDC Support');
			$this->email->to('sandeepk@icurocao.com');
			$this->email->cc('sandeep.kharay@gmail.com');
			$this->email->subject('File Uploading Error ALert');
			$this->email->message($message);
			$this->email->send();
			echo "sorry for inconvenience.problem with file.We Already send mail to system administrator about this error";
		 }
	 }
