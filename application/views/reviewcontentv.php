...
echo $sourceda;
 ?></td>
								...
								<td class="center">
<a href="<?php echo BASE_URL; ?>/addcontent/viewproductothers/<?php echo $value->mpt_id; ?>" class="cboxElements"><button class="btn btn-mini btn-primary">Raw View</button></a>&nbsp;<a href="<?php echo BASE_URL; ?>/addcontent/viewproductothersqa/<?php echo $value->mpt_id; ?>" class="cboxElement"><button class="btn btn-mini btn-primary">View For QA</button></a>&nbsp;<a href="<?php echo BASE_URL; ?>/addcontent/qafailed/<?php echo $value->mpt_id; ?>" class="cboxElement"><button class="btn btn-mini btn-primary">QA Failed Case</button></a>
								</td>
								<td class="center">
...
<button class="btn btn-mini btn-primary" onclick="return trashAllcontent('<?php echo BASE_URL; ?>')"><i class="icon-arrow-up icon-white"></i><span>Reject Content</span></button>
<script>
